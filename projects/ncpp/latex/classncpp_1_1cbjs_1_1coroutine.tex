...
\item 
\mbox{\Hypertarget{classncpp_1_1cbjs_1_1coroutine_a70237319281dd5df0566ffadfbdd7711}\label{classncpp_1_1cbjs_1_1coroutine_a70237319281dd5df0566ffadfbdd7711}} 
bool {\bfseries is\+\_\+has\+\_\+job} () const
\begin{DoxyCompactList}\small\item\em Indicating whether job\+\_\+p\+\_\+ is NULL. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Binding the thread fiber to use when job done,... \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Binding the job to run. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Changing the state updater by auto creating it from the passed arguments and switch to the owner thread fiber. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Changing the state updater and switch to the owner thread fiber. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Switching from owner thread fiber to the coroutine\textquotesingle{}s fiber. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Updating the state by calling state\+\_\+updater\+\_\+p\+\_\+-\/\texorpdfstring{$>$}{>}update(). \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\begin{DoxyCompactList}\small\item\em Changing the state updater to default and switch to the owner thread fiber. \end{DoxyCompactList}\end{DoxyCompactItemize}
